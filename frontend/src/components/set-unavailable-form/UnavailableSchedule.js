...
const UnavailableSchedule = (props) => {
  const { date, account_id, start_time_id, end_time_id, availability } = props.values;
  ...
  { key: 'Available', text: 'Available', value: true },
  { key: 'Unavailable', text: 'Unavailable', value: false }
]
